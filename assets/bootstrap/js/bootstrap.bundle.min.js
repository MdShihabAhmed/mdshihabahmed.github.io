!function (t, e) {
  ...
  "use strict";
  const t = {find: (t, e = document.documentElement) => [].concat(...Element.prototype.querySelectorAll.call(e, t)), findOne: (t, e = document.documentElement) => Element.prototype.querySelector.call(e, t), children: (t, e) => [].concat(...t.children).filter(t => t.matches(e)), parents(t, e) {
    const i = [];
    let n = t.parentNode;
    ...
    t.addEventListener("transitionend", function e() {
      i = true, t.removeEventListener("transitionend", e);
    }), setTimeout(() => {
      i || r(t);
    }, n);
  }, d = (t, e, i) => {
  ...
  function j(t, e, i, n, s) {
    ...
    const h = e.replace(E, "") && `${e.replace(E, "")}::${O++}` || r.uidEvent || O++, u = o ? function (t, e, i) {
      return function n(s) {
  ...
  const H = {on(t, e, i, n) {
    ...
    const n = g(), s = (e = e.replace(T, ""), k[e] || e), o = e !== s, r = x.has(s);
    let a, l = true, c = true, d = false, h = null;
    return o && n && (a = n.Event(e, i), n(t).trigger(a), l = !a.isPropagationStopped(), c = !a.isImmediatePropagationStopped(), d = a.isDefaultPrevented()), r ? (h = document.createEvent("HTMLEvents"), h.initEvent(s, l, true)) : h = new CustomEvent(e, {bubbles: l, cancelable: true}), void 0 !== i && Object.keys(i).forEach(t => {
  ...
  const U = {setDataAttribute(t, e, i) {
    t.setAttribute("data-bs-" + e.replace(/[A-Z]/g, t => "-" + e.toLowerCase()), i);
  }, removeDataAttribute(t, e) {
    t.removeAttribute("data-bs-" + e.replace(/[A-Z]/g, t => "-" + e.toLowerCase()));
  }, getDataAttributes(t) {
    if (!t) return {};
    const e = {};
    return Object.keys(t.dataset).filter(t => t.startsWith("bs")).forEach(i => {
      let n = i.replace(/^bs/, "");
      n = n.charAt(0).toLowerCase() + n.slice(1, n.length), e[n] = "true" === t.dataset[i] || "false" !== t.dataset[i] && (t.dataset[i] === Number(t.dataset[i]).toString() ? Number(t.dataset[i]) : "" === t.dataset[i] || "null" === t.dataset[i] ? null : t.dataset[i]);
    }), e;
  }, getDataAttribute: (t, e) => "true" === t.getAttribute("data-bs-" + e.replace(/[A-Z]/g, t => "-" + e.toLowerCase())) || "false" !== t.getAttribute("data-bs-" + e.replace(/[A-Z]/g, t => "-" + e.toLowerCase())) && (t.getAttribute("data-bs-" + e.replace(/[A-Z]/g, t => "-" + e.toLowerCase())) === Number(t.getAttribute("data-bs-" + e.replace(/[A-Z]/g, t => "-" + e.toLowerCase()))).toString() ? Number(t.getAttribute("data-bs-" + e.replace(/[A-Z]/g, t => "-" + e.toLowerCase()))) : "" === t.getAttribute("data-bs-" + e.replace(/[A-Z]/g, t => "-" + e.toLowerCase())) || "null" === t.getAttribute("data-bs-" + e.replace(/[A-Z]/g, t => "-" + e.toLowerCase())) ? null : t.getAttribute("data-bs-" + e.replace(/[A-Z]/g, t => "-" + e.toLowerCase()))), offset(t) {
    const e = t.getBoundingClientRect();
    return {top: e.top + document.body.scrollTop, left: e.left + document.body.scrollLeft};
  }, position: t => ({top: t.offsetTop, left: t.offsetLeft})}, $ = {interval: 5e3, keyboard: true, slide: false, pause: "hover", wrap: true, touch: true}, F = {interval: "(number|boolean)", keyboard: "boolean", slide: "(boolean|string)", pause: "(string|boolean)", wrap: "boolean", touch: "boolean"}, V = "next", K = "prev", X = "left", Y = "right";
  class Q extends R {
    constructor(e, i) {
      super(e), this._items = null, this._interval = null, this._activeElement = null, this._isPaused = false, this._isSliding = false, this.touchTimeout = null, this.touchStartX = 0, this.touchDeltaX = 0, this._config = this._getConfig(i), this._indicatorsElement = t.findOne(".carousel-indicators", this._element), this._touchSupported = "ontouchstart" in document.documentElement || navigator.maxTouchPoints > 0, this._pointerEvent = Boolean(window.PointerEvent), this._addEventListeners();
    }
    static get Default() {
      return $;
    }
    ...
    pause(e) {
      e || (this._isPaused = true), t.findOne(".carousel-item-next, .carousel-item-prev", this._element) && (r(this._element), this.cycle(true)), clearInterval(this._interval), this._interval = null;
    }
    cycle(t) {
    ...
    _slide(e, i) {
      ...
      if (r && r.classList.contains("active")) return void (this._isSliding = false);
      ...
      if (this._element.classList.contains("slide")) {
        ...
        const t = () => {
          r.classList.remove(d, h), r.classList.add("active"), s.classList.remove("active", h, d), this._isSliding = false, setTimeout(f, 0);
        };
        this._queueCallback(t, s, true);
      } else s.classList.remove("active"), r.classList.add("active"), this._isSliding = false, f();
      l && this.cycle();
    }
    _directionToOrder(t) {
    ...
    static dataApiClickHandler(t) {
      ...
      n && (i.interval = false), Q.carouselInterface(e, i), n && w.get(e, "bs.carousel").to(n), t.preventDefault();
    }
  }
  ...
  class J extends R {
    constructor(e, i) {
      super(e), this._isTransitioning = false, this._config = this._getConfig(i), this._triggerArray = t.find(`[data-bs-toggle="collapse"][href="#${this._element.id}"],[data-bs-toggle="collapse"][data-bs-target="#${this._element.id}"]`);
    ...
    show() {
      ...
      this._element.classList.remove("collapse"), this._element.classList.add("collapsing"), this._element.style[s] = 0, this._triggerArray.length && this._triggerArray.forEach(t => {
        t.classList.remove("collapsed"), t.setAttribute("aria-expanded", true);
      }), this.setTransitioning(true);
      const o = "scroll" + (s[0].toUpperCase() + s.slice(1));
      this._queueCallback(() => {
        this._element.classList.remove("collapsing"), this._element.classList.add("collapse", "show"), this._element.style[s] = "", this.setTransitioning(false), H.trigger(this._element, "shown.bs.collapse");
      }, this._element, true), this._element.style[s] = this._element[o] + "px";
    }
    hide() {
      if (this._isTransitioning || !this._element.classList.contains("show")) return;
      ...
      if (e > 0) for (let t = 0; t < e; t++) {
        ...
        i && !i.classList.contains("show") && (e.classList.add("collapsed"), e.setAttribute("aria-expanded", false));
      }
      this.setTransitioning(true), this._element.style[t] = "", this._queueCallback(() => {
    ...
    static collapseInterface(t, e) {
      ...
      if (!i && n.toggle && "string" == typeof e && /show|hide/.test(e) && (n.toggle = false), i || (i = new J(t, n)), "string" == typeof e) {
  ...
  var ft = {name: "applyStyles", enabled: true, phase: "write", fn: function (t) {
    var e = t.state;
    Object.keys(e.elements).forEach(function (t) {
      var i = e.styles[t] || {}, n = e.attributes[t] || {}, s = e.elements[t];
      (s instanceof ct(s).HTMLElement || s instanceof HTMLElement) && lt(s) && (Object.assign(s.style, i), Object.keys(n).forEach(function (t) {
        var e = n[t];
        false === e ? s.removeAttribute(t) : s.setAttribute(t, true === e ? "" : e);
      }));
    });
  }, effect: function (t) {
    ...
    return Object.assign(e.elements.popper.style, i.popper), e.styles = i, e.elements.arrow && Object.assign(e.elements.arrow.style, i.arrow), function () {
      Object.keys(e.elements).forEach(function (t) {
        ...
        (n instanceof ct(n).HTMLElement || n instanceof HTMLElement) && lt(n) && (Object.assign(n.style, o), Object.keys(s).forEach(function (t) {
          n.removeAttribute(t);
        }));
      });
    };
  ...
  function _t(t, e) {
    ...
    if (i && ("undefined" != typeof ShadowRoot && (i instanceof ct(i).ShadowRoot || i instanceof ShadowRoot))) {
      var n = e;
      do {
  ...
  function yt(t) {
    return ((t instanceof ct(t).Element || t instanceof Element ? t.ownerDocument : t.document) || window.document).documentElement;
  }
  function wt(t) {
    return "html" === lt(t) ? t : t.assignedSlot || t.parentNode || ("undefined" != typeof ShadowRoot && (t instanceof ct(t).ShadowRoot || t instanceof ShadowRoot) ? t.host : null) || yt(t);
  }
  function Et(t) {
    return (t instanceof ct(t).HTMLElement || t instanceof HTMLElement) && "fixed" !== ct(t).getComputedStyle(t).position ? t.offsetParent : null;
  }
  function Tt(t) {
    for (var e = ct(t), i = Et(t); i && ["table", "td", "th"].indexOf(lt(i)) >= 0 && "static" === ct(i).getComputedStyle(i).position;) i = Et(i);
    return i && ("html" === lt(i) || "body" === lt(i) && "static" === ct(i).getComputedStyle(i).position) ? e : i || function (t) {
      var e = -1 !== navigator.userAgent.toLowerCase().indexOf("firefox");
      if (-1 !== navigator.userAgent.indexOf("Trident") && (t instanceof ct(t).HTMLElement || t instanceof HTMLElement) && "fixed" === ct(t).getComputedStyle(t).position) return null;
      for (var i = wt(t); (i instanceof ct(i).HTMLElement || i instanceof HTMLElement) && ["html", "body"].indexOf(lt(i)) < 0;) {
        var n = ct(i).getComputedStyle(i);
  ...
  var Nt = {name: "arrow", enabled: true, phase: "main", fn: function (t) {
    var e, i = t.state, n = t.name, s = t.options, o = i.elements.arrow, r = i.modifiersData.popperOffsets, a = i.placement.split("-")[0], l = At(a), c = [nt, it].indexOf(a) >= 0 ? "height" : "width";
    if (o && r) {
      var d = function (t, e) {
        return Object.assign({}, {top: 0, right: 0, bottom: 0, left: 0}, "number" != typeof (t = "function" == typeof t ? t(Object.assign({}, e.rects, {placement: e.placement})) : t) ? t : Dt(t, st));
      }(s.padding, i), h = gt(o), u = "y" === l ? tt : nt, f = "y" === l ? et : it, p = i.rects.reference[c] + i.rects.reference[l] - r[l] - i.rects.popper[c], m = r[l] - i.rects.reference[l], g = Tt(o), _ = g ? "y" === l ? g.clientHeight || 0 : g.clientWidth || 0 : 0, b = p / 2 - m / 2, v = d[u], y = _ - h[c] - d[f], w = _ / 2 - h[c] / 2 + b, E = Lt(v, Ot(w, y)), T = l;
  ...
  function It(t) {
    var e, i = t.popper, n = t.popperRect, s = t.placement, o = t.offsets, r = t.position, a = t.gpuAcceleration, l = t.adaptive, c = t.roundOffsets, d = true === c ? function (t) {
    ...
    if (l) {
      ...
      y === ct(i) && "static" !== ct(y = yt(i)).getComputedStyle(y = yt(i)).position && (w = "scrollHeight", E = "scrollWidth"), y = y, s === tt && (b = et, p -= y[w] - n.height, p *= a ? 1 : -1), s === nt && (_ = it, u -= y[E] - n.width, u *= a ? 1 : -1);
    }
  ...
  var jt = {name: "computeStyles", enabled: true, phase: "beforeWrite", fn: function (t) {
    var e = t.state, i = t.options, n = i.gpuAcceleration, s = void 0 === n || n, o = i.adaptive, r = void 0 === o || o, a = i.roundOffsets, l = void 0 === a || a, c = {placement: e.placement.split("-")[0], popper: e.elements.popper, popperRect: e.rects.popper, gpuAcceleration: s};
  ...
  }, data: {}}, Pt = {passive: true}, Mt = {name: "eventListeners", enabled: true, phase: "write", fn: function () {}, effect: function (t) {
  ...
  function Ut(t) {
    var e = ct(t).getComputedStyle(t), i = e.overflow, n = e.overflowX, s = e.overflowY;
  ...
  function $t(t, e) {
    ...
    void 0 === e && (e = []);
    var n = function t(e) {
      return ["html", "body", "#document"].indexOf(lt(e)) >= 0 ? e.ownerDocument.body : (e instanceof ct(e).HTMLElement || e instanceof HTMLElement) && Ut(e) ? e : t(wt(e));
    }(t), s = n === (null == (i = t.ownerDocument) ? void 0 : i.body), o = ct(n), r = s ? [o].concat(o.visualViewport || [], Ut(n) ? n : []) : n, a = e.concat(r);
    return s ? a : a.concat($t(wt(r)));
  }
  function Vt(t, e) {
    return "viewport" === e ? Object.assign({}, function (t) {
      var e = ct(t), i = yt(t), n = e.visualViewport, s = i.clientWidth, o = i.clientHeight, r = 0, a = 0;
      return n && (s = n.width, o = n.height, /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || (r = n.offsetLeft, a = n.offsetTop)), {width: s, height: o, x: r + (mt(yt(t)).left + qt(t).scrollLeft), y: a};
    }(t), {left: function (t) {
      var e = ct(t), i = yt(t), n = e.visualViewport, s = i.clientWidth, o = i.clientHeight, r = 0, a = 0;
      return n && (s = n.width, o = n.height, /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || (r = n.offsetLeft, a = n.offsetTop)), {width: s, height: o, x: r + (mt(yt(t)).left + qt(t).scrollLeft), y: a};
    }(t).x, top: function (t) {
      var e = ct(t), i = yt(t), n = e.visualViewport, s = i.clientWidth, o = i.clientHeight, r = 0, a = 0;
      return n && (s = n.width, o = n.height, /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || (r = n.offsetLeft, a = n.offsetTop)), {width: s, height: o, x: r + (mt(yt(t)).left + qt(t).scrollLeft), y: a};
    }(t).y, right: function (t) {
      var e = ct(t), i = yt(t), n = e.visualViewport, s = i.clientWidth, o = i.clientHeight, r = 0, a = 0;
      return n && (s = n.width, o = n.height, /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || (r = n.offsetLeft, a = n.offsetTop)), {width: s, height: o, x: r + (mt(yt(t)).left + qt(t).scrollLeft), y: a};
    }(t).x + function (t) {
      var e = ct(t), i = yt(t), n = e.visualViewport, s = i.clientWidth, o = i.clientHeight, r = 0, a = 0;
      return n && (s = n.width, o = n.height, /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || (r = n.offsetLeft, a = n.offsetTop)), {width: s, height: o, x: r + (mt(yt(t)).left + qt(t).scrollLeft), y: a};
    }(t).width, bottom: function (t) {
      var e = ct(t), i = yt(t), n = e.visualViewport, s = i.clientWidth, o = i.clientHeight, r = 0, a = 0;
      return n && (s = n.width, o = n.height, /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || (r = n.offsetLeft, a = n.offsetTop)), {width: s, height: o, x: r + (mt(yt(t)).left + qt(t).scrollLeft), y: a};
    }(t).y + function (t) {
      var e = ct(t), i = yt(t), n = e.visualViewport, s = i.clientWidth, o = i.clientHeight, r = 0, a = 0;
      return n && (s = n.width, o = n.height, /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || (r = n.offsetLeft, a = n.offsetTop)), {width: s, height: o, x: r + (mt(yt(t)).left + qt(t).scrollLeft), y: a};
    }(t).height}) : e instanceof ct(e).HTMLElement || e instanceof HTMLElement ? function (t) {
      var e = mt(t);
      return e.top = e.top + t.clientTop, e.left = e.left + t.clientLeft, e.bottom = e.top + t.clientHeight, e.right = e.left + t.clientWidth, e.width = t.clientWidth, e.height = t.clientHeight, e.x = e.left, e.y = e.top, e;
    }(e) : Object.assign({}, function (t) {
      var e, i = yt(t), n = qt(t), s = null == (e = t.ownerDocument) ? void 0 : e.body, o = Lt(i.scrollWidth, i.clientWidth, s ? s.scrollWidth : 0, s ? s.clientWidth : 0), r = Lt(i.scrollHeight, i.clientHeight, s ? s.scrollHeight : 0, s ? s.clientHeight : 0), a = -n.scrollLeft + (mt(yt(t)).left + qt(t).scrollLeft), l = -n.scrollTop;
      return "rtl" === ct(s || i).getComputedStyle(s || i).direction && (a += Lt(i.clientWidth, s ? s.clientWidth : 0) - o), {width: o, height: r, x: a, y: l};
    }(yt(t)), {left: function (t) {
      var e, i = yt(t), n = qt(t), s = null == (e = t.ownerDocument) ? void 0 : e.body, o = Lt(i.scrollWidth, i.clientWidth, s ? s.scrollWidth : 0, s ? s.clientWidth : 0), r = Lt(i.scrollHeight, i.clientHeight, s ? s.scrollHeight : 0, s ? s.clientHeight : 0), a = -n.scrollLeft + (mt(yt(t)).left + qt(t).scrollLeft), l = -n.scrollTop;
      return "rtl" === ct(s || i).getComputedStyle(s || i).direction && (a += Lt(i.clientWidth, s ? s.clientWidth : 0) - o), {width: o, height: r, x: a, y: l};
    }(yt(t)).x, top: function (t) {
      var e, i = yt(t), n = qt(t), s = null == (e = t.ownerDocument) ? void 0 : e.body, o = Lt(i.scrollWidth, i.clientWidth, s ? s.scrollWidth : 0, s ? s.clientWidth : 0), r = Lt(i.scrollHeight, i.clientHeight, s ? s.scrollHeight : 0, s ? s.clientHeight : 0), a = -n.scrollLeft + (mt(yt(t)).left + qt(t).scrollLeft), l = -n.scrollTop;
      return "rtl" === ct(s || i).getComputedStyle(s || i).direction && (a += Lt(i.clientWidth, s ? s.clientWidth : 0) - o), {width: o, height: r, x: a, y: l};
    }(yt(t)).y, right: function (t) {
      var e, i = yt(t), n = qt(t), s = null == (e = t.ownerDocument) ? void 0 : e.body, o = Lt(i.scrollWidth, i.clientWidth, s ? s.scrollWidth : 0, s ? s.clientWidth : 0), r = Lt(i.scrollHeight, i.clientHeight, s ? s.scrollHeight : 0, s ? s.clientHeight : 0), a = -n.scrollLeft + (mt(yt(t)).left + qt(t).scrollLeft), l = -n.scrollTop;
      return "rtl" === ct(s || i).getComputedStyle(s || i).direction && (a += Lt(i.clientWidth, s ? s.clientWidth : 0) - o), {width: o, height: r, x: a, y: l};
    }(yt(t)).x + function (t) {
      var e, i = yt(t), n = qt(t), s = null == (e = t.ownerDocument) ? void 0 : e.body, o = Lt(i.scrollWidth, i.clientWidth, s ? s.scrollWidth : 0, s ? s.clientWidth : 0), r = Lt(i.scrollHeight, i.clientHeight, s ? s.scrollHeight : 0, s ? s.clientHeight : 0), a = -n.scrollLeft + (mt(yt(t)).left + qt(t).scrollLeft), l = -n.scrollTop;
      return "rtl" === ct(s || i).getComputedStyle(s || i).direction && (a += Lt(i.clientWidth, s ? s.clientWidth : 0) - o), {width: o, height: r, x: a, y: l};
    }(yt(t)).width, bottom: function (t) {
      var e, i = yt(t), n = qt(t), s = null == (e = t.ownerDocument) ? void 0 : e.body, o = Lt(i.scrollWidth, i.clientWidth, s ? s.scrollWidth : 0, s ? s.clientWidth : 0), r = Lt(i.scrollHeight, i.clientHeight, s ? s.scrollHeight : 0, s ? s.clientHeight : 0), a = -n.scrollLeft + (mt(yt(t)).left + qt(t).scrollLeft), l = -n.scrollTop;
      return "rtl" === ct(s || i).getComputedStyle(s || i).direction && (a += Lt(i.clientWidth, s ? s.clientWidth : 0) - o), {width: o, height: r, x: a, y: l};
    }(yt(t)).y + function (t) {
      var e, i = yt(t), n = qt(t), s = null == (e = t.ownerDocument) ? void 0 : e.body, o = Lt(i.scrollWidth, i.clientWidth, s ? s.scrollWidth : 0, s ? s.clientWidth : 0), r = Lt(i.scrollHeight, i.clientHeight, s ? s.scrollHeight : 0, s ? s.clientHeight : 0), a = -n.scrollLeft + (mt(yt(t)).left + qt(t).scrollLeft), l = -n.scrollTop;
  ...
  function Xt(t) {
    var e, i = t.reference, n = t.element, s = t.placement, o = s ? s.split("-")[0] : null, r = s ? s.split("-")[1] : null, a = i.x + i.width / 2 - n.width / 2, l = i.y + i.height / 2 - n.height / 2;
    switch (o) {
      case tt:
  ...
  function Yt(t, e) {
    void 0 === e && (e = {});
    var i = e, n = i.placement, s = void 0 === n ? t.placement : n, o = i.boundary, r = void 0 === o ? "clippingParents" : o, a = i.rootBoundary, l = void 0 === a ? "viewport" : a, c = i.elementContext, d = void 0 === c ? "popper" : c, h = i.altBoundary, u = void 0 !== h && h, f = i.padding, p = void 0 === f ? 0 : f, m = Object.assign({}, {top: 0, right: 0, bottom: 0, left: 0}, "number" != typeof p ? p : Dt(p, st)), g = "popper" === d ? "reference" : "popper", _ = t.elements.reference, b = t.rects.popper, v = t.elements[u ? g : d], y = function (t, e, i) {
      var n = "clippingParents" === e ? function (t) {
        var e = $t(wt(t)), i = ["absolute", "fixed"].indexOf(ct(t).getComputedStyle(t).position) >= 0 && (t instanceof ct(t).HTMLElement || t instanceof HTMLElement) ? Tt(t) : t;
        return i instanceof ct(i).Element || i instanceof Element ? e.filter(function (t) {
          return (t instanceof ct(t).Element || t instanceof Element) && _t(t, i) && "body" !== lt(t);
        }) : [];
    ...
    }(v instanceof ct(v).Element || v instanceof Element ? v : v.contextElement || yt(t.elements.popper), r, l), w = mt(_), E = Xt({reference: w, element: b, strategy: "absolute", placement: s}), T = Object.assign({}, Object.assign({}, b, E), {left: Object.assign({}, b, E).x, top: Object.assign({}, b, E).y, right: Object.assign({}, b, E).x + Object.assign({}, b, E).width, bottom: Object.assign({}, b, E).y + Object.assign({}, b, E).height}), A = "popper" === d ? T : w, L = {top: y.top - A.top + m.top, bottom: A.bottom - y.bottom + m.bottom, left: y.left - A.left + m.left, right: A.right - y.right + m.right}, O = t.modifiersData.offset;
    if ("popper" === d && O) {
      var k = O[s];
  ...
  function Qt(t, e) {
    void 0 === e && (e = {});
    var i = e, n = i.placement, s = i.boundary, o = i.rootBoundary, r = i.padding, a = i.flipVariations, l = i.allowedAutoPlacements, c = void 0 === l ? rt : l, d = n.split("-")[1], h = d ? a ? ot : ot.filter(function (t) {
      return t.split("-")[1] === d;
    ...
    var f = u.reduce(function (e, i) {
      return e[i] = Yt(t, {placement: i, boundary: s, rootBoundary: o, padding: r})[i.split("-")[0]], e;
    }, {});
    return Object.keys(f).sort(function (t, e) {
      return f[t] - f[e];
    });
  }
  var Gt = {name: "flip", enabled: true, phase: "main", fn: function (t) {
    var e = t.state, i = t.options, n = t.name;
    if (!e.modifiersData[n]._skip) {
      for (var s = i.mainAxis, o = void 0 === s || s, r = i.altAxis, a = void 0 === r || r, l = i.fallbackPlacements, c = i.padding, d = i.boundary, h = i.rootBoundary, u = i.altBoundary, f = i.flipVariations, p = void 0 === f || f, m = i.allowedAutoPlacements, g = e.options.placement, _ = g.split("-")[0], b = l || (_ !== g && p ? function (t) {
        if ("auto" === t.split("-")[0]) return [];
        var e = Rt(t);
        return [Wt(t), e, Wt(e)];
      }(g) : [Rt(g)]), v = [g].concat(b).reduce(function (t, i) {
        return t.concat("auto" === i.split("-")[0] ? Qt(e, {placement: i, boundary: d, rootBoundary: h, padding: c, flipVariations: p, allowedAutoPlacements: m}) : i);
      }, []), y = e.rects.reference, w = e.rects.popper, E = new Map, T = true, A = v[0], L = 0; L < v.length; L++) {
        var O = v[L], k = O.split("-")[0], C = "start" === O.split("-")[1], x = [tt, et].indexOf(k) >= 0, D = x ? "width" : "height", N = Yt(e, {placement: O, boundary: d, rootBoundary: h, altBoundary: u, padding: c}), S = x ? C ? it : nt : C ? et : tt;
        y[D] > w[D] && (S = Rt(S));
        var I = Rt(S), j = [];
      ...
      e.placement !== A && (e.modifiersData[n]._skip = true, e.placement = A, e.reset = true);
    }
  ...
  var te = {name: "hide", enabled: true, phase: "main", requiresIfExists: ["preventOverflow"], fn: function (t) {
    var e = t.state, i = t.name, n = e.rects.reference, s = e.rects.popper, o = e.modifiersData.preventOverflow, r = Yt(e, {elementContext: "reference"}), a = Yt(e, {altBoundary: true}), l = (void 0 === i && (i = {x: 0, y: 0}), {top: r.top - n.height - i.y, right: r.right - n.width + i.x, bottom: r.bottom - n.height + i.y, left: r.left - n.width - i.x}), c = (void 0 === o && (o = {x: 0, y: 0}), {top: a.top - s.height - o.y, right: a.right - s.width + o.x, bottom: a.bottom - s.height + o.y, left: a.left - s.width - o.x}), d = Jt(l), h = Jt(c);
  ...
  }}, ee = {name: "offset", enabled: true, phase: "main", requires: ["popperOffsets"], fn: function (t) {
    var e = t.state, i = t.options, n = t.name, s = i.offset, o = void 0 === s ? [0, 0] : s, r = rt.reduce(function (t, i) {
      return t[i] = function (t, e, i) {
        var n = t.split("-")[0], s = [nt, tt].indexOf(n) >= 0 ? -1 : 1, o = "function" == typeof i ? i(Object.assign({}, e, {placement: t})) : i, r = o[0], a = o[1];
        return r = r || 0, a = (a || 0) * s, [nt, it].indexOf(n) >= 0 ? {x: a, y: r} : {x: r, y: a};
      }(i, e.rects, o), t;
    }, {}), a = r[e.placement], l = a.x, c = a.y;
    null != e.modifiersData.popperOffsets && (e.modifiersData.popperOffsets.x += l, e.modifiersData.popperOffsets.y += c), e.modifiersData[n] = r;
  }}, ie = {name: "popperOffsets", enabled: true, phase: "read", fn: function (t) {
    var e = t.state, i = t.name;
    e.modifiersData[i] = Xt({reference: e.rects.reference, element: e.rects.popper, strategy: "absolute", placement: e.placement});
  }, data: {}}, ne = {name: "preventOverflow", enabled: true, phase: "main", fn: function (t) {
    var e = t.state, i = t.options, n = t.name, s = i.mainAxis, o = void 0 === s || s, r = i.altAxis, a = void 0 !== r && r, l = i.boundary, c = i.rootBoundary, d = i.altBoundary, h = i.padding, u = i.tether, f = void 0 === u || u, p = i.tetherOffset, m = void 0 === p ? 0 : p, g = Yt(e, {boundary: l, rootBoundary: c, padding: h, altBoundary: d}), _ = e.placement.split("-")[0], b = e.placement.split("-")[1], v = !b, y = At(_), w = "x" === y ? "y" : "x", E = e.modifiersData.popperOffsets, T = e.rects.reference, A = e.rects.popper, L = "function" == typeof m ? m(Object.assign({}, e.rects, {placement: e.placement})) : m, O = {x: 0, y: 0};
    if (E) {
      if (o || a) {
        var k = "y" === y ? tt : nt, C = "y" === y ? et : it, x = "y" === y ? "height" : "width", D = E[y], N = E[y] + g[k], S = E[y] - g[C], I = f ? -A[x] / 2 : 0, j = "start" === b ? T[x] : A[x], P = "start" === b ? -A[x] : -T[x], M = e.elements.arrow, H = f && M ? gt(M) : {width: 0, height: 0}, R = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : {top: 0, right: 0, bottom: 0, left: 0}, B = R[k], W = R[C], q = Lt(0, Ot(T[x], H[x])), z = v ? T[x] / 2 - I - q - B - L : j - q - B - L, U = v ? -T[x] / 2 + I + q + W + L : P + q + W + L, $ = e.elements.arrow && Tt(e.elements.arrow), F = $ ? "y" === y ? $.clientTop || 0 : $.clientLeft || 0 : 0, V = e.modifiersData.offset ? e.modifiersData.offset[e.placement][y] : 0, K = E[y] + z - V - F, X = E[y] + U - V;
        if (o) {
          var Y = Lt(f ? Ot(N, K) : N, Ot(D, f ? Lt(S, X) : S));
          E[y] = Y, O[y] = Y - D;
        }
        if (a) {
          var Q = "x" === y ? tt : nt, G = "x" === y ? et : it, Z = E[w], J = Z + g[Q], st = Z - g[G], ot = Lt(f ? Ot(J, K) : J, Ot(Z, f ? Lt(st, X) : st));
          E[w] = ot, O[w] = ot - Z;
        }
      }
      e.modifiersData[n] = O;
  ...
  function se(t, e, i) {
    void 0 === i && (i = false);
    var n, s, o = yt(e), r = mt(t), a = e instanceof ct(e).HTMLElement || e instanceof HTMLElement, l = {scrollLeft: 0, scrollTop: 0}, c = {x: 0, y: 0};
    return (a || !a && !i) && (("body" !== lt(e) || Ut(o)) && (l = (n = e) !== ct(n) && (n instanceof ct(n).HTMLElement || n instanceof HTMLElement) ? {scrollLeft: (s = n).scrollLeft, scrollTop: s.scrollTop} : qt(n)), e instanceof ct(e).HTMLElement || e instanceof HTMLElement ? ((c = mt(e)).x += e.clientLeft, c.y += e.clientTop) : o && (c.x = mt(yt(o)).left + qt(o).scrollLeft)), {x: r.left + l.scrollLeft - c.x, y: r.top + l.scrollTop - c.y, width: r.width, height: r.height};
  }
  ...
  function ae(t) {
    ...
    return function (t, e, i) {
      void 0 === i && (i = o);
      var s, r, a = {placement: "bottom", orderedModifiers: [], options: Object.assign({}, oe, o), modifiersData: {}, elements: {reference: t, popper: e}, attributes: {}, styles: {}}, l = [], c = false, d = {state: a, setOptions: function (i) {
        h(), a.options = Object.assign({}, o, a.options, i), a.scrollParents = {reference: t instanceof ct(t).Element || t instanceof Element ? $t(t) : t.contextElement ? $t(t.contextElement) : [], popper: $t(e)};
        ...
        if (!c) {
          ...
          if (re(e, i)) {
            a.rects = {reference: se(e, Tt(i), "fixed" === a.options.strategy), popper: gt(i)}, a.reset = false, a.placement = a.options.placement, a.orderedModifiers.forEach(function (t) {
              return a.modifiersData[t.name] = Object.assign({}, t.data);
            });
            for (var n = 0; n < a.orderedModifiers.length; n++) if (true !== a.reset) {
  ...
  class we extends R {
    ...
    show() {
      ...
      if (!H.trigger(this._element, "show.bs.dropdown", e).defaultPrevented) {
        if (this._inNavbar) U.setDataAttribute(this._menu, "popper", "none"); else {
          ...
          const i = this._getPopperConfig(), n = i.modifiers.find(t => "applyStyles" === t.name && false === t.enabled);
          this._popper = de(e, this._menu, i), n && U.setDataAttribute(this._menu, "popper", "static");
        }
        "ontouchstart" in document.documentElement && !t.closest(".navbar-nav") && [].concat(...document.body.children).forEach(t => H.on(t, "mouseover", p)), this._element.focus(), this._element.setAttribute("aria-expanded", true), this._menu.classList.toggle("show"), this._element.classList.toggle("show"), H.trigger(this._element, "shown.bs.dropdown", e);
      }
    }
    hide() {
      if (u(this._element) || !this._menu.classList.contains("show")) return;
    ...
    _getPopperConfig() {
      ...
      return "static" === this._config.display && (t.modifiers = [{name: "applyStyles", enabled: false}]), {...t, ..."function" == typeof this._config.popperConfig ? this._config.popperConfig(t) : this._config.popperConfig};
    }
    _selectMenuItem(e) {
    ...
    static clearMenus(e) {
      ...
      for (let t = 0, n = i.length; t < n; t++) {
        ...
        if (!n || false === n._config.autoClose) continue;
  ...
  class Ie extends R {
    constructor(e, i) {
      super(e), this._config = this._getConfig(i), this._dialog = t.findOne(".modal-dialog", this._element), this._backdrop = this._initializeBackDrop(), this._isShown = false, this._ignoreBackdropClick = false, this._isTransitioning = false;
    }
    static get Default() {
      return Ne;
    }
    ...
    show(t) {
      ...
      this._isShown || e.defaultPrevented || (this._isShown = true, Te(), document.body.classList.add("modal-open"), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), H.on(this._element, "click.dismiss.bs.modal", '[data-bs-dismiss="modal"]', t => this.hide(t)), H.on(this._dialog, "mousedown.dismiss.bs.modal", () => {
        H.one(this._element, "mouseup.dismiss.bs.modal", t => {
          t.target === this._element && (this._ignoreBackdropClick = true);
        });
    ...
    hide(t) {
      ...
      e && (this._isTransitioning = true), this._setEscapeEvent(), this._setResizeEvent(), H.off(document, "focusin.bs.modal"), this._element.classList.remove("show"), H.off(this._element, "click.dismiss.bs.modal"), H.off(this._dialog, "mousedown.dismiss.bs.modal"), this._queueCallback(() => this._hideModal(), this._element, e);
    }
    dispose() {
    ...
    _showElement(e) {
      ...
      this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", true), this._element.setAttribute("role", "dialog"), this._element.scrollTop = 0, n && (n.scrollTop = 0), i && m(this._element), this._element.classList.add("show"), this._config.focus && this._enforceFocus(), this._queueCallback(() => {
        this._config.focus && this._element.focus(), this._isTransitioning = false, H.trigger(this._element, "shown.bs.modal", {relatedTarget: e});
      }, this._dialog, i);
    }
    _enforceFocus() {
    ...
    _showBackdrop(t) {
      H.on(this._element, "click.dismiss.bs.modal", t => {
        this._ignoreBackdropClick ? this._ignoreBackdropClick = false : t.target === t.currentTarget && (true === this._config.backdrop ? this.hide() : "static" === this._config.backdrop && this._triggerBackdropTransition());
  ...
  class Me extends R {
    constructor(t, e) {
      super(t), this._config = this._getConfig(e), this._isShown = false, this._backdrop = this._initializeBackDrop(), this._addEventListeners();
    }
    static get NAME() {
      return "offcanvas";
    }
  ...
  const He = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"]), Re = /^(?:(?:https?|mailto|ftp|tel|file):|[^#&/:?]*(?:[#/?]|$))/i, Be = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[\d+/a-z]+=*$/i, We = (t, e) => {
    const i = t.nodeName.toLowerCase();
    if (e.includes(i)) return !He.has(i) || Boolean(Re.test(t.nodeValue) || Be.test(t.nodeValue));
    const n = e.filter(t => t instanceof RegExp);
    for (let t = 0, e = n.length; t < e; t++) if (n[t].test(i)) return true;
    return false;
  };
  function qe(t, e, i) {
  ...
  class Xe extends R {
    ...
    hide() {
      ...
      t.classList.remove("show"), "ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach(t => H.off(t, "mouseover", p)), this._activeTrigger.click = false, this._activeTrigger.focus = false, this._activeTrigger.hover = false;
    ...
    _enter(t, e) {
      e = this._initializeOnDelegatedTarget(t, e), t && (e._activeTrigger["focusin" === t.type ? "focus" : "hover"] = true), e.getTipElement().classList.contains("show") || "show" === e._hoverState ? e._hoverState = "show" : (clearTimeout(e._timeout), e._hoverState = "show", e._config.delay && e._config.delay.show ? e._timeout = setTimeout(() => {
    ...
    _isWithActiveTrigger() {
      for (const t in this._activeTrigger) if (this._activeTrigger[t]) return true;
      return false;
    }
    _getConfig(t) {
      ...
      return Object.keys(e).forEach(t => {
        Ue.has(t) && delete e[t];
      }), (t = {...this.constructor.Default, ...e, ..."object" == typeof t && t ? t : {}}).container = false === t.container ? document.body : l(t.container), "number" == typeof t.delay && (t.delay = {show: t.delay, hide: t.delay}), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), d("tooltip", t, this.constructor.DefaultType), t.sanitize && (t.template = qe(t.template, t.allowList, t.sanitizeFn)), t;
    }
    _getDelegateConfig() {
      const t = {};
  ...
  class ni extends R {
    ...
    _activate(e, i, n) {
      ...
      s && o ? (s.classList.remove("show"), this._queueCallback(r, e, true)) : r();
    }
    _transitionComplete(e, i, n) {
      if (i) {
        i.classList.remove("active");
        const e = t.findOne(":scope > .dropdown-menu .active", i.parentNode);
        e && e.classList.remove("active"), "tab" === i.getAttribute("role") && i.setAttribute("aria-selected", false);
      }
      e.classList.add("active"), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", true), m(e), e.classList.contains("fade") && e.classList.add("show");
      let s = e.parentNode;
      if (s && "LI" === s.nodeName && (s = s.parentNode), s && s.classList.contains("dropdown-menu")) {
        const i = e.closest(".dropdown");
        i && t.find(".dropdown-toggle", i).forEach(t => t.classList.add("active")), e.setAttribute("aria-expanded", true);
      }
      n && n();
    }
    static jQueryInterface(t) {
  ...
  class ri extends R {
    constructor(t, e) {
      super(t), this._config = this._getConfig(e), this._timeout = null, this._hasMouseInteraction = false, this._hasKeyboardInteraction = false, this._setListeners();
    }
    static get DefaultType() {
      return si;
    }
    ...
    _setListeners() {
      H.on(this._element, "click.dismiss.bs.toast", '[data-bs-dismiss="toast"]', () => this.hide()), H.on(this._element, "mouseover.bs.toast", t => this._onInteraction(t, true)), H.on(this._element, "mouseout.bs.toast", t => this._onInteraction(t, false)), H.on(this._element, "focusin.bs.toast", t => this._onInteraction(t, true)), H.on(this._element, "focusout.bs.toast", t => this._onInteraction(t, false));
    }
    _clearTimeout() {
